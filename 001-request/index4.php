...
<?php
$day = isset($_REQUEST['day']) ? (int) $_REQUEST['day'] : ''; // isset($_REQUEST['day']) nếu true lấy sau dấy ? , nếu false lấy sau dấu :
...
if (isset($_REQUEST['day']) && isset($_REQUEST['month']) && isset($_REQUEST['year'])) {
    ...
    $current_day = date("d/m/Y",time()); // lấy thời gian hiện tại
